...
We appreciate all contributions to the player, large or small. Please take the time to read through this document before making a contribution to ensure a fun and productive process for everyone involved.
...
## Pull Requests
Pull requests are a great way to help out and improve JW Player. If you've never contributed before, don't worry - we'll do the best we can to help get your PR merged. Unsure of where to start? Refer to the Questions/Discussions guidelines and drop us a line. 

Before embarking on a large PR, please inform us beforehand - we may not need  your changes in the repo and don't want to waste your time.
...
2. We don't demand 100% coverage, but please write tests that cover at least the happy paths
    - Some code is hard to test or untestable - we won't hold it against you if you're working in a particularly difficult area
3. If your changes cannot be automated, include a manual test page that demonstrates the functionality of your changes

##### Style
1. Ensure that your code follows our styleguide by passing our ESLint rules
2. Do your best to match our naming conventions and conform to the style of the code around you

##### Size
1. Do your best to keep your PRs as small and focused as possible. Break your PRs up if they're large
