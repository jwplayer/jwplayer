...
describe('style-loader-test', () => {
    ...
    it('cssUtils.css creates a new style tag if one for the playerId does not exist', () => {
    ...
    it('cssUtils.css adds player styles to style element unique to the playerId', () => {
    ...
    it('cssUtils.css replaces styles of the selector when it already exists', () => {
    ...
    it('cssUtils.clear clears the style tag but does not remove it', () => {
