...
describe('os-version', () => {
    it('returns the browser version from a Chrome user agent', () => {
    ...
    it('returns the browser version from a CriOS user agent', () => {
    ...
    it('returns the browser version from a Safari user agent', () => {
    ...
    it('returns the browser version from a Firefox user agent', () => {
    ...
    it('returns the browser version from a Microsoft user agent, rv', () => {
    ...
    it('returns the browser version from a Microsoft user agent, MSIE', () => {
    ...
    it('returns the browser version from a Microsoft user agent, Edge', () => {
