...
/**
 * Event triggered once an ad tag is loaded containing all companion creatives
*/
 ...
 *
*/
export const CAST_AD_CHANGED = 'castAdChanged';
 ...
 *
*/
export const PROVIDER_CLICK = 'providerClick';

/**
 *
*/
export const VIEW_TAB_FOCUS = 'tabFocus';

/**
 *
*/
export const CONTROLBAR_DRAGGING = 'scrubbing';
