...
import { PlayerError, MSG_CANT_LOAD_PLAYER } from 'api/errors';
...
function _error(options, message, code, error) {
    options.onerror(message, options.url, options.xhr, new PlayerError(MSG_CANT_LOAD_PLAYER, code, error));
}
