...
//		protected var _removedButtons:Array = [];
		...
		protected var _defaultLayout:String = "[play custom10 custom11 custom12 custom13 prev next custom20 custom21 custom22 custom23 elapsed][time alt][duration custom30 custom31 custom32 custom33 hd cc custom40 custom41 custom42 custom43 mute volumeH fullscreen]";
		...
		*/
		...
		private function setupDefaultButtons():void {
			...
			addComponentButton('custom10', ViewEvent.JWPLAYER_VIEW_CUSTOM10);
			addComponentButton('custom11', ViewEvent.JWPLAYER_VIEW_CUSTOM11);
			addComponentButton('custom12', ViewEvent.JWPLAYER_VIEW_CUSTOM12);
			addComponentButton('custom13', ViewEvent.JWPLAYER_VIEW_CUSTOM13);
			addComponentButton('custom20', ViewEvent.JWPLAYER_VIEW_CUSTOM20);
			addComponentButton('custom21', ViewEvent.JWPLAYER_VIEW_CUSTOM21);
			addComponentButton('custom22', ViewEvent.JWPLAYER_VIEW_CUSTOM22);
			addComponentButton('custom23', ViewEvent.JWPLAYER_VIEW_CUSTOM23);
			addComponentButton('custom30', ViewEvent.JWPLAYER_VIEW_CUSTOM30);
			addComponentButton('custom31', ViewEvent.JWPLAYER_VIEW_CUSTOM31);
			addComponentButton('custom32', ViewEvent.JWPLAYER_VIEW_CUSTOM32);
			addComponentButton('custom33', ViewEvent.JWPLAYER_VIEW_CUSTOM33);
			addComponentButton('custom40', ViewEvent.JWPLAYER_VIEW_CUSTOM40);
			addComponentButton('custom41', ViewEvent.JWPLAYER_VIEW_CUSTOM41);
			addComponentButton('custom42', ViewEvent.JWPLAYER_VIEW_CUSTOM42);
			addComponentButton('custom43', ViewEvent.JWPLAYER_VIEW_CUSTOM43);
